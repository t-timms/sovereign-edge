...
[![CI](https://img.shields.io/github/actions/workflow/status/t-timms/sovereign-edge/ci.yml?style=flat-square&label=CI)](https://github.com/t-timms/sovereign-edge/actions/workflows/ci.yml)
